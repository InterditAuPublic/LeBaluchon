...
class Service {
    ...
    var urlSession: any URLSessionProtocol = URLSession(configuration: .default)
    
    func loadData(callback: @escaping (Bool) -> Void) {
        let urlRequest = URLRequest(url: URL(string:"https://swapi.dev/api/people/1/")!)
...
//     STD = "S\U00e3o Tom\U00e9 and Pr\U00edncipe Dobra";
//     SVC = "Salvadoran Col\U00f3n";
//     SYP = "Syrian Pound";
//     SZL = "Swazi Lilangeni";
//     THB = "Thai Baht";
...
//     UYU = "Uruguayan Peso";
//     UZS = "Uzbekistan Som";
//     VEF = "Venezuelan Bol\U00edvar Fuerte";
